...
let s:grey        = { "gui": "#8F908A", "cterm": "240" }
let s:lightgrey   = { "gui": "#575b61", "cterm": "242" }
let s:darkgrey    = { "gui": "#64645e", "cterm": "238" }
let s:warmgrey    = { "gui": "#75715E", "cterm": "59"  }

let s:pink         = { "gui": "#87005f", "cterm": "132" }
let s:green        = { "gui": "#A6E22D", "cterm": "172" }
let s:commentGreen = { "gui": "#005f00", "cterm": "22"  }
let s:aqua         = { "gui": "#66d9ef", "cterm": "68"  }
let s:yellow       = { "gui": "#f2c566", "cterm": "221" }
...
call s:h("TODOs",         { "fg": s:orange,   "format": "bold,italic"})
