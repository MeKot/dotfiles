...
DIR_OF_THIRD_PARTY = os.path.join( DIR_OF_THIS_SCRIPT, '../.vim/plugged/YouCompleteMe/third_party' )
...
jni_flags = ['-I/usr/lib/jvm/java-8-jdk/include/',
             '-I/usr/lib/jvm/java-8-jdk/include/linux']
...
includes = ['-I/opt/cuda/include',
            '-I/home/admin/Imperial/embedded/contiki/platform/',
            '-I/home/admin/Imperial/embedded/contiki/lib/',
            '-I/home/admin/Imperial/embedded/contiki/core/lib/',
            '-I/home/admin/Imperial/embedded/contiki/tools/powertrace/',
            '-I/home/admin/Imperial/embedded/contiki/core/contiki.h']
